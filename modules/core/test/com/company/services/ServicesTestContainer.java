...
public class ServicesTestContainer extends TestContainer {

    public ServicesTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/services/app.properties",
    ...
    public static class Common extends ServicesTestContainer {

        public static final ServicesTestContainer.Common INSTANCE = new ServicesTestContainer.Common();
